...
IMAGES_DATA = [
    ...
    # },
    # {
    #     'path': 'data/sequences/latest.tif',
    #     'values': {
    #         'right': CORRECT_LATEST_RIGHT,
    #         'left': CORRECT_LATEST_LEFT,
    #         'up': CORRECT_LATEST_UP,
    #         'down': CORRECT_LATEST_DOWN,
